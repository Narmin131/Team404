...
//   1.1.length -> dəyişkənin içində olanların sayını göstərir.
//                 metn = "Salam";
//                 lenght.metn;
...
// JS`də massivlər üçün olan methodlar
const myArray = [12, 45, 23, 9]
// Map metodu 
const arr1 = myArray.map((item) => {
    return item * 3
})
console.log(arr1);
...
// Find metodu
const arr2 = myArray.find(item => item > 20)
console.log(arr2);

// Filter metodu
const arr3 = myArray.filter((item)=>{
    return item > 20
})
console.log(arr3);

// Foreach metodu
const arr4 = myArray.forEach(num => console.log(num))
